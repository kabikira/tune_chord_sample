...
// Project imports:
import 'package:chord_fracture/src/pages/chordForm/chord_form_detail.dart';
import 'package:chord_fracture/src/pages/chordForm/chord_form_edit.dart';
import 'package:chord_fracture/src/pages/chordForm/chord_form_list.dart';
import 'package:chord_fracture/src/pages/chordForm/chord_form_register.dart';
import 'package:chord_fracture/src/pages/navBar/nav_bar.dart';
import 'package:chord_fracture/src/pages/search/search_page.dart';
import 'package:chord_fracture/src/pages/settings/settings.dart';
import 'package:chord_fracture/src/pages/splash/splash.dart';
import 'package:chord_fracture/src/pages/tuning/tuning_list.dart';
import 'package:chord_fracture/src/router/router_observer.dart';
